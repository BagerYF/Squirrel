...
extension AppSchema {
  class CheckoutShippingAddressUpdateV2Mutation: GraphQLMutation {
    static let operationName: String = "checkoutShippingAddressUpdateV2"
    static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"mutation checkoutShippingAddressUpdateV2($checkoutId: ID!, $shippingAddress: MailingAddressInput!) { checkoutShippingAddressUpdateV2( checkoutId: $checkoutId shippingAddress: $shippingAddress ) { __typename checkout { __typename ...CheckoutCommon availableShippingRates { __typename ready shippingRates { __typename handle priceV2 { __typename amount currencyCode } title } } } checkoutUserErrors { __typename code field message } } }"#,
        fragments: [CheckoutCommon.self]
      ))

    public var checkoutId: ID
    public var shippingAddress: MailingAddressInput
    ...
    struct Data: AppSchema.SelectionSet {
      ...
      static var __selections: [Apollo.Selection] { [
        .field("checkoutShippingAddressUpdateV2", CheckoutShippingAddressUpdateV2?.self, arguments: [
          "checkoutId": .variable("checkoutId"),
          "shippingAddress": .variable("shippingAddress")
        ]),
      ] }

      /// Updates the shipping address of an existing checkout.
      var checkoutShippingAddressUpdateV2: CheckoutShippingAddressUpdateV2? { __data["checkoutShippingAddressUpdateV2"] }

      /// CheckoutShippingAddressUpdateV2
      ///
      /// Parent Type: `CheckoutShippingAddressUpdateV2Payload`
      struct CheckoutShippingAddressUpdateV2: AppSchema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: Apollo.ParentType { AppSchema.Objects.CheckoutShippingAddressUpdateV2Payload }
        static var __selections: [Apollo.Selection] { [
        ...
        struct Checkout: AppSchema.SelectionSet {
          ...
          /// CheckoutShippingAddressUpdateV2.Checkout.AvailableShippingRates
          ///
          ...
          struct AvailableShippingRates: AppSchema.SelectionSet {
            ...
            /// CheckoutShippingAddressUpdateV2.Checkout.AvailableShippingRates.ShippingRate
            ///
            ...
            struct ShippingRate: AppSchema.SelectionSet {
              ...
              /// CheckoutShippingAddressUpdateV2.Checkout.AvailableShippingRates.ShippingRate.PriceV2
              ///
              /// Parent Type: `MoneyV2`
        ...
        /// CheckoutShippingAddressUpdateV2.CheckoutUserError
        ///

...
extension AppSchema {
  class AddProductsToCartMutation: GraphQLMutation {
    static let operationName: String = "addProductsToCart"
    ...
    struct Data: AppSchema.SelectionSet {
      ...
      struct CartLinesAdd: AppSchema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: Apollo.ParentType { AppSchema.Objects.CartLinesAddPayload }
        static var __selections: [Apollo.Selection] { [

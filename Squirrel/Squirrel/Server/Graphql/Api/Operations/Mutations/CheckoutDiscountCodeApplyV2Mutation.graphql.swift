...
extension AppSchema {
  class CheckoutDiscountCodeApplyV2Mutation: GraphQLMutation {
    static let operationName: String = "checkoutDiscountCodeApplyV2"
    static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"mutation checkoutDiscountCodeApplyV2($checkoutId: ID!, $discountCode: String!) { checkoutDiscountCodeApplyV2( checkoutId: $checkoutId discountCode: $discountCode ) { __typename checkout { __typename ...CheckoutCommon availableShippingRates { __typename ready shippingRates { __typename handle priceV2 { __typename amount currencyCode } title } } shippingLine { __typename handle priceV2 { __typename amount currencyCode } title } } checkoutUserErrors { __typename code field message } } }"#,
    ...
    struct Data: AppSchema.SelectionSet {
      ...
      static var __selections: [Apollo.Selection] { [
        .field("checkoutDiscountCodeApplyV2", CheckoutDiscountCodeApplyV2?.self, arguments: [
          "checkoutId": .variable("checkoutId"),
          "discountCode": .variable("discountCode")
        ]),
      ] }

      /// Applies a discount to an existing checkout using a discount code.
      var checkoutDiscountCodeApplyV2: CheckoutDiscountCodeApplyV2? { __data["checkoutDiscountCodeApplyV2"] }

      /// CheckoutDiscountCodeApplyV2
      ///
      /// Parent Type: `CheckoutDiscountCodeApplyV2Payload`
      struct CheckoutDiscountCodeApplyV2: AppSchema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: Apollo.ParentType { AppSchema.Objects.CheckoutDiscountCodeApplyV2Payload }
        static var __selections: [Apollo.Selection] { [
        ...
        struct Checkout: AppSchema.SelectionSet {
          ...
          /// CheckoutDiscountCodeApplyV2.Checkout.AvailableShippingRates
          ///
          ...
          struct AvailableShippingRates: AppSchema.SelectionSet {
            ...
            /// CheckoutDiscountCodeApplyV2.Checkout.AvailableShippingRates.ShippingRate
            ///
            ...
            struct ShippingRate: AppSchema.SelectionSet {
              ...
              /// CheckoutDiscountCodeApplyV2.Checkout.AvailableShippingRates.ShippingRate.PriceV2
              ///
              /// Parent Type: `MoneyV2`
          ...
          /// CheckoutDiscountCodeApplyV2.Checkout.ShippingLine
          ///
          /// Parent Type: `ShippingRate`
          struct ShippingLine: AppSchema.SelectionSet {
            ...
            /// CheckoutDiscountCodeApplyV2.Checkout.ShippingLine.PriceV2
            ///
            /// Parent Type: `MoneyV2`
            struct PriceV2: AppSchema.SelectionSet {
              let __data: DataDict
        ...
        /// CheckoutDiscountCodeApplyV2.CheckoutUserError
        ///

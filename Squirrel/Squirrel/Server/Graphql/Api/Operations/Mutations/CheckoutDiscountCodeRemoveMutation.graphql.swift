...
extension AppSchema {
  class CheckoutDiscountCodeRemoveMutation: GraphQLMutation {
    static let operationName: String = "checkoutDiscountCodeRemove"
    ...
    struct Data: AppSchema.SelectionSet {
      ...
      var checkoutDiscountCodeRemove: CheckoutDiscountCodeRemove? { __data["checkoutDiscountCodeRemove"] }

      /// CheckoutDiscountCodeRemove
      ///
      /// Parent Type: `CheckoutDiscountCodeRemovePayload`
      struct CheckoutDiscountCodeRemove: AppSchema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: Apollo.ParentType { AppSchema.Objects.CheckoutDiscountCodeRemovePayload }
        static var __selections: [Apollo.Selection] { [

...
extension AppSchema {
  class CheckoutCompleteFreeMutation: GraphQLMutation {
    static let operationName: String = "checkoutCompleteFree"
    ...
    struct Data: AppSchema.SelectionSet {
      ...
      static var __selections: [Apollo.Selection] { [
        .field("checkoutCompleteFree", CheckoutCompleteFree?.self, arguments: ["checkoutId": .variable("checkoutId")]),
      ] }

      /// Completes a checkout without providing payment information. You can use this mutation for free items or items whose purchase price is covered by a gift card.
      var checkoutCompleteFree: CheckoutCompleteFree? { __data["checkoutCompleteFree"] }

      /// CheckoutCompleteFree
      ///
      /// Parent Type: `CheckoutCompleteFreePayload`
      struct CheckoutCompleteFree: AppSchema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: Apollo.ParentType { AppSchema.Objects.CheckoutCompleteFreePayload }
        static var __selections: [Apollo.Selection] { [
        ...
        struct Checkout: AppSchema.SelectionSet {
          ...
          /// CheckoutCompleteFree.Checkout.AvailableShippingRates
          ///
          ...
          struct AvailableShippingRates: AppSchema.SelectionSet {
            ...
            /// CheckoutCompleteFree.Checkout.AvailableShippingRates.ShippingRate
            ///
            ...
            struct ShippingRate: AppSchema.SelectionSet {
              ...
              /// CheckoutCompleteFree.Checkout.AvailableShippingRates.ShippingRate.PriceV2
              ///
              /// Parent Type: `MoneyV2`
          ...
          /// CheckoutCompleteFree.Checkout.ShippingLine
          ///
          /// Parent Type: `ShippingRate`
          struct ShippingLine: AppSchema.SelectionSet {
            ...
            /// CheckoutCompleteFree.Checkout.ShippingLine.PriceV2
            ///
            /// Parent Type: `MoneyV2`
            struct PriceV2: AppSchema.SelectionSet {
              let __data: DataDict
        ...
        /// CheckoutCompleteFree.CheckoutUserError
        ///

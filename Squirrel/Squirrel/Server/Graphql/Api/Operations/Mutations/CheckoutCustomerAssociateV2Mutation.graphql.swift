...
extension AppSchema {
  class CheckoutCustomerAssociateV2Mutation: GraphQLMutation {
    static let operationName: String = "checkoutCustomerAssociateV2"
    static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"mutation checkoutCustomerAssociateV2($checkoutId: ID!, $customerAccessToken: String!) { checkoutCustomerAssociateV2( checkoutId: $checkoutId customerAccessToken: $customerAccessToken ) { __typename checkout { __typename ...CheckoutCommon availableShippingRates { __typename ready shippingRates { __typename handle priceV2 { __typename amount currencyCode } title } } shippingLine { __typename handle priceV2 { __typename amount currencyCode } title } } checkoutUserErrors { __typename code field message } customer { __typename id } } }"#,
    ...
    struct Data: AppSchema.SelectionSet {
      ...
      static var __selections: [Apollo.Selection] { [
        .field("checkoutCustomerAssociateV2", CheckoutCustomerAssociateV2?.self, arguments: [
      ...
      var checkoutCustomerAssociateV2: CheckoutCustomerAssociateV2? { __data["checkoutCustomerAssociateV2"] }

      /// CheckoutCustomerAssociateV2
      ///
      /// Parent Type: `CheckoutCustomerAssociateV2Payload`
      struct CheckoutCustomerAssociateV2: AppSchema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: Apollo.ParentType { AppSchema.Objects.CheckoutCustomerAssociateV2Payload }
        static var __selections: [Apollo.Selection] { [
        ...
        struct Checkout: AppSchema.SelectionSet {
          ...
          /// CheckoutCustomerAssociateV2.Checkout.AvailableShippingRates
          ///
          ...
          struct AvailableShippingRates: AppSchema.SelectionSet {
            ...
            /// CheckoutCustomerAssociateV2.Checkout.AvailableShippingRates.ShippingRate
            ///
            ...
            struct ShippingRate: AppSchema.SelectionSet {
              ...
              /// CheckoutCustomerAssociateV2.Checkout.AvailableShippingRates.ShippingRate.PriceV2
              ///
              /// Parent Type: `MoneyV2`
          ...
          /// CheckoutCustomerAssociateV2.Checkout.ShippingLine
          ///
          /// Parent Type: `ShippingRate`
          struct ShippingLine: AppSchema.SelectionSet {
            ...
            /// CheckoutCustomerAssociateV2.Checkout.ShippingLine.PriceV2
            ///
            /// Parent Type: `MoneyV2`
            struct PriceV2: AppSchema.SelectionSet {
              let __data: DataDict
        ...
        /// CheckoutCustomerAssociateV2.CheckoutUserError
        ///

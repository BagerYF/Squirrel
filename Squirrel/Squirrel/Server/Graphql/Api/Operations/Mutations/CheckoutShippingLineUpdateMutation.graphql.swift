...
extension AppSchema {
  class CheckoutShippingLineUpdateMutation: GraphQLMutation {
    static let operationName: String = "checkoutShippingLineUpdate"
    static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"mutation checkoutShippingLineUpdate($checkoutId: ID!, $shippingRateHandle: String!) { checkoutShippingLineUpdate( checkoutId: $checkoutId shippingRateHandle: $shippingRateHandle ) { __typename checkout { __typename ...CheckoutCommon availableShippingRates { __typename ready shippingRates { __typename handle priceV2 { __typename amount currencyCode } title } } shippingLine { __typename handle priceV2 { __typename amount currencyCode } title } } checkoutUserErrors { __typename code field message } } }"#,
        fragments: [CheckoutCommon.self]
      ))

    public var checkoutId: ID
    public var shippingRateHandle: String
    ...
    struct Data: AppSchema.SelectionSet {
      ...
      static var __selections: [Apollo.Selection] { [
        .field("checkoutShippingLineUpdate", CheckoutShippingLineUpdate?.self, arguments: [
          "checkoutId": .variable("checkoutId"),
          "shippingRateHandle": .variable("shippingRateHandle")
        ]),
      ] }

      /// Updates the shipping lines on an existing checkout.
      var checkoutShippingLineUpdate: CheckoutShippingLineUpdate? { __data["checkoutShippingLineUpdate"] }

      /// CheckoutShippingLineUpdate
      ///
      /// Parent Type: `CheckoutShippingLineUpdatePayload`
      struct CheckoutShippingLineUpdate: AppSchema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: Apollo.ParentType { AppSchema.Objects.CheckoutShippingLineUpdatePayload }
        static var __selections: [Apollo.Selection] { [
        ...
        struct Checkout: AppSchema.SelectionSet {
          ...
          /// CheckoutShippingLineUpdate.Checkout.AvailableShippingRates
          ///
          ...
          struct AvailableShippingRates: AppSchema.SelectionSet {
            ...
            /// CheckoutShippingLineUpdate.Checkout.AvailableShippingRates.ShippingRate
            ///
            ...
            struct ShippingRate: AppSchema.SelectionSet {
              ...
              /// CheckoutShippingLineUpdate.Checkout.AvailableShippingRates.ShippingRate.PriceV2
              ///
              /// Parent Type: `MoneyV2`
          ...
          /// CheckoutShippingLineUpdate.Checkout.ShippingLine
          ///
          /// Parent Type: `ShippingRate`
          struct ShippingLine: AppSchema.SelectionSet {
            ...
            /// CheckoutShippingLineUpdate.Checkout.ShippingLine.PriceV2
            ///
            /// Parent Type: `MoneyV2`
            struct PriceV2: AppSchema.SelectionSet {
              let __data: DataDict
        ...
        /// CheckoutShippingLineUpdate.CheckoutUserError
        ///

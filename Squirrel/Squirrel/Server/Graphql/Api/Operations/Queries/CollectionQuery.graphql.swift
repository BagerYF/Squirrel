...
extension AppSchema {
  class CollectionQuery: GraphQLQuery {
    ...
    public init(
      ...
      sortKey: GraphQLNullable<GraphQLEnum<ProductCollectionSortKeys>>,
      filters: GraphQLNullable<[ProductFilter]>,
    ...
    struct Data: AppSchema.SelectionSet {
      ...
      struct Collection: AppSchema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: Apollo.ParentType { AppSchema.Objects.Collection }
        static var __selections: [Apollo.Selection] { [
              ...
              struct Variants: AppSchema.SelectionSet {
                ...
                struct Edge: AppSchema.SelectionSet {
                  ...
                  struct Node: AppSchema.SelectionSet {
                    ...
                    /// Collection.Products.Edge.Node.Variants.Edge.Node.CompareAtPrice
                    ///
                    /// Parent Type: `MoneyV2`
                    ...
                    /// Collection.Products.Edge.Node.Variants.Edge.Node.Image
                    ///
                    /// Parent Type: `Image`

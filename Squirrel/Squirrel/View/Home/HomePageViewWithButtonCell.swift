    ...
    class HomePageViewWithButtonCell: UITableViewCell, FSPagerViewDelegate, FSPagerViewDataSource {
        ...
        func initView() {
            ...
            pagerView.register(FSPagerViewCell.self, forCellWithReuseIdentifier: "HomePageViewWithButtonPagerCell")
        ...
        override func layoutSubviews() {
            ...
            button.frame = CGRect(x: 16, y: 661, width: self.contentView.bounds.width - 32, height: 40)
        }
        ...
        func pagerView(_ pagerView: FSPagerView, cellForItemAt index: Int) -> FSPagerViewCell {
            let item = data[index]
            let cell = pagerView.dequeueReusableCell(withReuseIdentifier: "HomePageViewWithButtonPagerCell", at: index)
